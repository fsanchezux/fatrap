// Factory defaults for the drop -> stampable-files relation used by index2.html.
// Served by GET /api/drops when the DB has no saved relation yet. Keep in sync
// with scripts/build-index2-data.mjs.
export const DEFAULT_DROPS: Record<string, string[]> = {
